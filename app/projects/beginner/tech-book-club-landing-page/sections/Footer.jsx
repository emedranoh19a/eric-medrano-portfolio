...
export default function Footer() {
  return (
    <footer className="relative z-0 bg-[var(--neutral-900)] pt-12 sm:pt-16 lg:pt-20 px-4 sm:px-8 lg:px-[125px] flex flex-col items-center">
      <Pattern variant="dark" />
      <CTA />
      <hr className="text-[var(--neutral-900)] w-full" />
      <div className="w-full flex flex-col sm:flex-row justify-between items-center py-6 gap-4">
        <Text as="span" className="text-[var(--neutral-0)]" preset={7}>
  ...
  return (
    <>
      <Text
        as="h2"
        preset={2}
        className="text-[var(--neutral-0)] max-w-[753px] mx-auto text-center mb-10"
      >
