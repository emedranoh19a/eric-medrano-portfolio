...
export default function Content() {
  ...
  const titleStyles = cn(
    "antialiased mb-5 mx-auto text-center text-(--neutral-900) sm:max-w-[538px] lg:max-w-none",
    bp === "base" || bp === "sm" ? "preset-1-mobile" : "preset-1"
  );
  return (
    <div>
      <h1 className={titleStyles}> Design solutions made easy</h1>
      <p className="preset-4 text-(--neutral-400) antialiased text-pretty text-center mx-auto max-w-[569px]">
