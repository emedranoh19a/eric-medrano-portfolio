...
export default function CartItem({ id, quantity }) {
  ...
  return (
    <div className="flex justify-between py-3 items-center border-b-2 border-(--rose-50)">
      ...
      <button
        ...
        className="border-2 border-(--rose-300) rounded-full p-1 group hover:border-(--rose-500)"
      >
