...
export default function Content() {
  return (
    <div className="bg-(--blue-950) h-fit col-start-1 lg:pr-16 pt-9 lg:pt-20 gap-y-10 col-span-2 self-center  h-full w-full grid lg:max-w-2xl">
      <div className="self-center flex flex-col gap-4 md:max-w-sm lg:max-w-2xl">
        ...
        <Text preset={2} className="text-(--blue-300) lg:max-w-lg">
