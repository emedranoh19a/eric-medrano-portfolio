...
import { bgDesktop, bgMobile, illustrationMockups, logo } from "./imageIndex"
...
export default function Page() {
    return <div className={`${poppins.className} grid place-items-center text-white relative z-0 w-full min-h-screen bg-[#684BB1] px-10 lg:px-20 py-10`}>
        <div className="w-full h-full">
            ...
            <Image className="absolute object-cover -z-10 hidden lg:block" fill alt="" src={bgDesktop} />
            <Image className="absolute object-cover -z-10 lg:hidden" fill alt="" src={bgMobile} />
...
function Logo() {
    return <div className="relative w-36 sm:w-56 h-20 ">
        <Image alt="Huddle logo" fill className="object-contain" src={logo} />
    </div>
}
function Illustration() {
    return <div className="relative w-full h-[209px] lg:h-[493px]">
        <Image alt="Huddle mockups" fill className="object-contain" src={illustrationMockups} />
    </div>
}
function Content() {
