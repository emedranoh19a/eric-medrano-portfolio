    ...
    <div className={`w-full h-screen bg-gray-950 relative ${overpass.className}`}>
      <RatingCard>
        {!isRanked ? (
          <>
            <Star />
            <h2 className=" text-3xl font-bold">How did we do?</h2>
            <p className="text-gray-400 tracking-wider leading-relaxed">
          ...
          <>
            ...
            <div className="bg-gray-700 rounded-full py-2 px-4 text-center text-orange-500">
              {" "}
              <p>You selected {rank} out of 5</p>
            </div>
