...
export default function Button({ variant = "cyan", text }) {
  const buttonStyles = cn(
    "group px-10 py-4 flex gap-1 w-fit rounded-full transition-colors cursor-pointer",
    variant === "cyan" && "bg-(--cyan-600) hover:bg-[#71c0d4]",
    variant === "purple" && "bg-(--purple-600) hover:bg-[#b18bdd]"
  );
