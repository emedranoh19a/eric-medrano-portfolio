...
export default function CTA() {
  const containerStyles = clsx(
    "relative w-full  max-w-6xl xl:max-w-(--breakpoint-2xl)  w-full grid   mx-auto",
    "mt-10 pb-10",
    "md:mt-20 md:pb-20",
    "xl:mt-40 xl:pb-40",
    "xl:pl-40"
...
function Content() {
  return (
    <>
      <Text preset={2} className="text-(--purple-100) font-normal">
        Be the first to test
      </Text>

      <Text preset={4} className="text-white text-(--purple-100)">
